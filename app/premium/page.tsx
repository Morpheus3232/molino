...
export const metadata = createRouteMetadata({
  ...
  path: "/premium",
  ogTitle: "Molino Premium — Tu Mapa Completo de Arquetipos",
  ogDescription: "Entendé tu mapa completo: arquetipos, ciclos de vida y dinámicas entre tus energías. Herramienta de reflexión honesta, no oráculo.",
});
