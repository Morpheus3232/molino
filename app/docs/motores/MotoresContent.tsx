...
const engines = [
  {
    ...
    slug: "numerologia",
    description: "Calcula Camino de Vida, Expresión, Personalidad y Ciclos de vida. Camino de Vida, Personalidad y Ciclos salen de la fecha de nacimiento; Expresión, del nombre completo.",
    formulas: [
