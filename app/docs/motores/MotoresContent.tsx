          ...
          {engines.map((engine, engineIndex) => (
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-accent/10 text-accent flex-shrink-0 mt-1">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-1 px-4 py-2 rounded-lg border border-border bg-background text-sm font-medium hover:border-accent hover:text-accent transition-colors"
                >
