...
export const metadata: Metadata = {
  ...
  description: "Mirá cómo se ve un mapa personal de Molino: numerología, astrología y zodíaco chino cruzados, con el perfil ficticio de María.",
  alternates: {
    canonical: siteUrl("/ejemplo"),
  },
  openGraph: {
    title: "Ejemplo de mapa personal — Molino",
    description: "Numerología, astrología y zodíaco chino cruzados en un mapa personal. Este es un ejemplo ficticio de cómo se ve el tuyo.",
    type: "article",
    url: siteUrl("/ejemplo"),
