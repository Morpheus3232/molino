...
export const metadata: Metadata = {
  title: "Numerolog&iacute;a — El lenguaje simb&oacute;lico de los n&uacute;meros",
  description: "Aprendé sobre numerología: Camino de Vida, Expression, Soul, Personality, números maestros y el sistema pitagórico. Una guía completa para entender tu mapa numérico.",
  openGraph: {
    title: "Numerolog&iacute;a — Molino",
