          ...
          >
            <main className="mx-auto max-w-[1100px] px-4 sm:px-6 pt-12 sm:pt-20 pb-24" id="main-content">
              ...
              <motion.section {...fadeUp} className="mb-12 sm:mb-16">
                ...
                <p className="text-xs uppercase tracking-[0.3em] text-accent font-medium mb-4">Compatibilidad · Países</p>
              ...
              {top10.length > 0 && (
                <section className="mb-14">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xs uppercase tracking-[0.2em] text-muted font-medium">Tus 10 países ideales</h2>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                    {top10.map((r, i) => (
                      ...
                      >
                        ...
                        <p className="text-xs uppercase tracking-[0.2em] text-muted">{r.targetAnimal}</p>
                        <AnimatePresence>
              ...
              <section className="mb-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-px bg-border" aria-hidden="true" />
                  <h2 className="text-xs uppercase tracking-[0.2em] text-muted font-medium">Explorar todos los países</h2>
                </div>
