    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-content px-4 sm:px-6 py-24 text-center">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-semibold tracking-tight text-foreground mb-4">Países que resuenan con tu mapa</h1>
      ...
      <main className="mx-auto max-w-[1100px] px-4 sm:px-6 pt-12 sm:pt-20 pb-24" id="main-content">
        ...
        <section className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar país..." className="input flex-1 max-w-sm" aria-label="Buscar país" />
                    ...
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                      <div className="px-2 py-4 pl-12 space-y-2">
                        ...
                        <div className="flex flex-wrap gap-3 mt-3 text-xs text-muted">
                          <span>Tu signo: {userAnimal}</span><span>·</span><span>País: {r.targetAnimal} de {r.targetElement}</span><span>·</span><span>{r.meta.reference} ({r.meta.year})</span>
                        </div>
