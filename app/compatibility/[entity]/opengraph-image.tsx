...
export const alt = "Análisis de compatibilidad";
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 48 }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
          <span style={{ color: "#241F17", fontSize: 20, fontWeight: 600, fontFamily: "sans-serif" }}>Molino</span>
          <span style={{ color: "#9A4A18", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.25em" }}>
            Compatibilidad
          </span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 48, flex: 1 }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ color: "#241F17", fontSize: 36, fontWeight: 700, fontFamily: "sans-serif" }}>
            {entity.name}
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
          <div style={{
            ...
            background: "#241F17", display: "flex",
