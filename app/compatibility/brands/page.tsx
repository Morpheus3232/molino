      ...
      <main className="mx-auto max-w-[1100px] px-4 sm:px-6 pt-12 sm:pt-20 pb-24" id="main-content">
        ...
        <motion.section {...fadeUp} className="mb-12 sm:mb-16">
          ...
          <p className="text-base text-muted mt-6 max-w-xl leading-relaxed">
            Tu signo <span className="font-medium text-foreground">{userAnimal}</span> de <span className="font-medium text-foreground">{userElement}</span> se conecta con cada marca a través de su signo del zodiaco chino del año de fundación.
          </p>
