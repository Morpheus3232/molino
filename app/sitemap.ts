...
import { allProgrammaticRoutes } from "@/lib/seo/programmatic";
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE_URL}/widget`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.6 },
  ...
  // Programmatic SEO — generated by scripts/generate-seo-routes.mjs
  const programmaticPages = allProgrammaticRoutes().map((route) => ({
