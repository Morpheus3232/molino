            ...
            >
              ...
              >
                <div className="text-center mb-8">
                  ...
                  >
                    <span className="px-3 py-1 rounded-none border border-border transition-colors hover:border-accent/40">{result.element}</span>
                    <span className="px-3 py-1 rounded-none border border-border transition-colors hover:border-accent/40">{result.modality}</span>
                  </motion.div>
                </div>
