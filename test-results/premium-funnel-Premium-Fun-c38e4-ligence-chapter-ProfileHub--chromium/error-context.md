...
- Name: premium-funnel.spec.ts >> Premium Funnel E2E >> Premium Gate visible on Intelligence chapter (ProfileHub)
- Location: e2e/premium-funnel.spec.ts:4:7
...
Locator: locator('button:has-text("Volver a mi mapa")').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Volver a mi mapa")').first()
...
- main:
  ...
  - tabpanel "Tu Lectura Premium":
    ...
    - paragraph: Lectura completa
    - heading "Ya conocés tus piezas. Ahora entendé cómo se conectan." [level=3]
    - paragraph: "Tu síntesis completa reúne tus sistemas en una sola lectura: qué patrones se alinean, qué tensiones aparecen y qué importa en tu momento actual."
    - paragraph: Tu Camino de Vida es 8. Tu animal chino es Serpiente. Dos sistemas distintos, calculados por separado.
    - paragraph: La síntesis completa explica qué significa esa combinación en tu caso — no qué son por separado.
    - paragraph: QUÉ VAS A LEER
    - blockquote: Tu numerología, astrología y zodíaco chino cuentan tres historias distintas. La síntesis completa las conecta en una sola lectura — qué significa todo esto en tu caso, no qué son por separado.
    - paragraph: ...y más.
    - paragraph: Tu síntesis completa
    - text: $8 USD
    - paragraph: Pago único · acceso permanente
    - button "Pagar con Mercado Pago"
    - button "Pagar con PayPal"
    - button "Recuperar acceso"
    - button "Tengo un cupón"
