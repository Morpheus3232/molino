...
export default function EphemeralWarning({ onDismiss }: EphemeralWarningProps) {
  return (
    <motion.div
      ...
      className="relative p-4 rounded-md bg-amber-50 border border-amber-200"
      role="alert"
    >
      <div className="flex items-start gap-3">
        ...
        <button
          type="button"
          onClick={onDismiss}
          className="flex-shrink-0 p-1 text-amber-500 hover:text-amber-700 transition-colors rounded-md hover:bg-amber-100"
