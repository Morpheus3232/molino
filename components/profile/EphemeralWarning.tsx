...
export default function EphemeralWarning({ onDismiss }: EphemeralWarningProps) {
  return (
    <motion.div
      ...
      className="relative p-4 rounded-xl bg-amber-50 border border-amber-200 dark:bg-amber-900/30 dark:border-amber-800"
      role="alert"
    >
      <div className="flex items-start gap-3">
        ...
        <button
          type="button"
          onClick={onDismiss}
          className="flex-shrink-0 p-1 text-amber-500 hover:text-amber-700 dark:hover:text-amber-300 transition-colors rounded-lg hover:bg-amber-100 dark:hover:bg-amber-800/50"
