        ...
        <div className="p-9 sm:p-11">
          ...
          >
            <div className="flex items-center gap-3">
              <svg width="22" height="22" viewBox="0 0 32 32" fill="none" stroke={ink} strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                <path d="M24 6 L24 11 L27 8.5 Z" fill={ink} stroke="none" opacity="0.7" />
                ...
                <circle cx="16" cy="8.5" r="1" fill={ink} stroke="none" />
              </svg>
