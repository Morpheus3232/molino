        ...
        <form onSubmit={handleSubmit} className="border border-ink/10 p-4 sm:p-5">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <input
              ...
              className="w-full min-h-[44px] flex-1 px-4 text-sm sm:text-base border border-ink/10 bg-background text-foreground placeholder:text-muted/70 focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_rgba(154,74,24,0.15)] transition-colors"
