          ...
          <div className="max-w-md w-full text-center py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full font-medium transition-all px-5 py-3 text-sm bg-primary text-primary-foreground shadow-sm hover:bg-accent hover:text-accent-foreground"
              >
                Intentar nuevamente
              </button>
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full font-medium transition-all px-5 py-3 text-sm bg-transparent text-secondary border border-border hover:border-accent hover:text-foreground"
              >
                Volver al inicio
              </button>
            </div>
