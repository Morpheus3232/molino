  ...
  astrology: {
    ...
    data: [
      ...
      },
      {
        label: "Elemento",
        value: "Aire",
        badge: "Géminis, Libra, Acuario",
        formula: "Elemento asignado al signo solar (tabla fija, sin ponderación)",
        meaning: "Prioridad a las conexiones conceptuales, el diálogo y la perspectiva lógica.",
      },
      {
        label: "Modalidad",
        value: "Mutable",
        badge: "Géminis, Virgo, Sagitario, Piscis",
        formula: "Modalidad asignada al signo solar (tabla fija, sin ponderación)",
        meaning: "Adaptabilidad, flexibilidad frente al cambio y facilidad para moverse entre contextos.",
      },
    ],
  },
  zodiac: {
