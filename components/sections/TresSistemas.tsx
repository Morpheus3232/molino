        ...
        >
          {systems.map((system, i) => (
            ...
            >
              ...
              <Link
                href={system.href}
                className="inline-flex items-center gap-2 text-accent hover:text-accent-hover transition-colors font-heading text-sm font-semibold uppercase tracking-wider"
              >
                Conocer más
