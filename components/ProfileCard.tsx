...
export default function ProfileCard({ archetype, energyBars, name }: ProfileCardProps) {
  return (
    <div className="rounded-2xl bg-white p-5 shadow-lg border border-black/[0.06]">
      <div className="mb-4 flex items-start justify-between">
        <div>
          ...
          <h2 className="font-serif text-2xl font-bold text-gray-900">{archetype.name}</h2>
          <p className="mt-1 text-sm text-gray-500">{archetype.keywords.join(" · ")}</p>
        </div>
      ...
      <blockquote
        className="mt-4 border-l-2 pl-3 text-sm italic text-gray-500"
