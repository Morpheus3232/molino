...
const Prism = ({
  ...
  useEffect(() => {
    ...
    const onMove = (e: globalThis.MouseEvent | globalThis.TouchEvent | globalThis.PointerEvent) => {
      ...
      const nx = (clientX - cx) / (ww * 0.5);
      const ny = (clientY - cy) / (wh * 0.5);
    ...
    let onPointerMove: ((e: globalThis.PointerEvent) => void) | null = null;
