...
export const BRANDS_60: AtlasEntityInput[] = [
  ...
  // ──── ROPA ADICIONAL ────
  {
    id: "adidas", name: "Adidas", type: "brand",
    country: "Alemania", emoji: "👟",
    category: "ropa",
    description: "La marca de las tres tiras, nacida de la rivalidad entre los hermanos Dassler y convertida en sinónimo de deporte y cultura urbana global.",
    keyThemes: ["Deporte", "Urbano", "Clásico", "Innovación"],
    events: [{ id: "adidas-fund", type: "fundacion", label: "Fundación", year: 1949, confidence: "media", primaryForAffinity: true, description: "Adolf Dassler fundó Adidas en Herzogenaurach tras separarse del negocio familiar que compartía con su hermano Rudolf, quien crearía Puma.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1949 por Adolf Dassler en Herzogenaurach.",
  },
  {
    id: "under-armour", name: "Under Armour", type: "brand",
    country: "Estados Unidos", emoji: "🏋️",
    category: "ropa",
    description: "Nacida de la obsesión de un jugador de fútbol americano por una camiseta que no se empapara de sudor, Under Armour revolucionó la ropa deportiva técnica.",
    keyThemes: ["Deporte", "Rendimiento", "Innovación", "Técnica"],
    events: [{ id: "under-armour-fund", type: "fundacion", label: "Fundación", year: 1996, confidence: "media", primaryForAffinity: true, description: "Kevin Plank, exjugador de fútbol americano de la Universidad de Maryland, fundó la empresa en el sótano de su abuela con una camiseta que absorbía el sudor.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1996 por Kevin Plank en Baltimore.",
  },
  {
    id: "new-balance", name: "New Balance", type: "brand",
    country: "Estados Unidos", emoji: "👟",
    category: "ropa",
    description: "La marca que convirtió el soporte del arco del pie en una obsesión y mantuvo su fabricación en Estados Unidos cuando todos se iban a Asia.",
    keyThemes: ["Artesanía", "Calzado", "Independencia", "Clásico"],
    events: [{ id: "new-balance-fund", type: "fundacion", label: "Fundación", year: 1906, confidence: "media", primaryForAffinity: true, description: "William J. Riley fundó la compañía en Boston como fabricante de soportes para el arco del pie, inspirado por la estabilidad de las gallinas.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1906 por William Riley en Boston.",
  },
  {
    id: "asics", name: "ASICS", type: "brand",
    country: "Japón", emoji: "🏃",
    category: "ropa",
    description: "Marca japonesa cuyo nombre es un acrónimo del proverbio latino «Anima Sana In Corpore Sano», llevando la filosofía y la ingeniería al running.",
    keyThemes: ["Running", "Japón", "Técnica", "Filosofía"],
    events: [{ id: "asics-fund", type: "fundacion", label: "Fundación", year: 1949, confidence: "media", primaryForAffinity: true, description: "Kihachiro Onitsuka fundó la empresa en Kobe, Japón, empezando con zapatillas de básquet hechas con materiales reciclados de la posguerra.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1949 por Kihachiro Onitsuka en Kobe.",
  },
  {
    id: "coach", name: "Coach", type: "brand",
    country: "Estados Unidos", emoji: "👜",
    category: "ropa",
    description: "La casa de marroquinería que convirtió el cuero estadounidense en lujo accesible, desde un pequeño taller de Manhattan al brazo de medio mundo.",
    keyThemes: ["Lujo", "Cuero", "Americano", "Artesanía"],
    events: [{ id: "coach-fund", type: "fundacion", label: "Fundación", year: 1941, confidence: "media", primaryForAffinity: true, description: "Seis artesanos del cuero fundaron Coach en un loft de Manhattan, inspirados por la durabilidad de los guantes de béisbol.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1941 en Manhattan, Nueva York.",
  },
  {
    id: "yves-saint-laurent", name: "Yves Saint Laurent", type: "brand",
    country: "Francia", emoji: "💋",
    category: "ropa",
    description: "Fundada en 1961, la maison del esmoquin femenino y la revolución del prêt-à-porter de lujo que liberó el cuerpo de la mujer.",
    keyThemes: ["Alta Costura", "Elegancia", "Revolución", "París"],
    events: [{ id: "yves-saint-laurent-fund", type: "fundacion", label: "Fundación", year: 1961, confidence: "media", primaryForAffinity: true, description: "Tras su paso por Dior, Yves Saint Laurent y Pierre Bergé fundaron la casa en París y presentaron el primer esmoquin para mujer en 1966.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1961 por Yves Saint Laurent en París.",
  },
  {
    id: "lululemon", name: "Lululemon", type: "brand",
    country: "Canadá", emoji: "🧘",
    category: "ropa",
    description: "La marca que convirtió los leggings de yoga en un fenómeno cultural y redefinió el «athleisure» como forma de vida global.",
    keyThemes: ["Yoga", "Bienestar", "Comunidad", "Innovación"],
    events: [{ id: "lululemon-fund", type: "fundacion", label: "Fundación", year: 1998, confidence: "media", primaryForAffinity: true, description: "Chip Wilson fundó la primera tienda en Vancouver como estudio de yoga que también vendía ropa técnica.", source: "Documentación histórica" }],
    sourceNote: "Fundada en 1998 por Chip Wilson en Vancouver.",
  },
];
