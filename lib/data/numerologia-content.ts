...
export const NUMBERS: NumerologyNumber[] = [
  ...
  },
  {
    ...
    meaning: "El 9 representa en la tradición numerológica la adaptabilidad extrema y el path del swing. No tiene origen fijo ni destino predeterminado. Se asocia con la capacidad de fluir con cualquier situación sin resistencia.",
    history: "En el pitagorismo, el 9 era el único número que siempre se reduce a sí mismo al multiplicarse (9×2=18→9, 9×3=27→9). En GG33 Academy, esta propiedad se interpreta como la capacidad del 9 de adaptarse a cualquier energía sin perderse.",
    strengths: ["Adaptabilidad extrema", "Lectura de situaciones", "Capacidad de unificar", "Fluidez social", "Desapego funcional"],
    challenges: ["Apego a situaciones que ya no funcionan", "Dificultad para establecer dirección propia", "Identidad difusa por exceso de adaptación", "Perderse en la energía de otros", "Evitar el compromiso con excusa de flexibilidad"],
    symbolism: "El 9 se asocia con la energía del swing: oscila entre polos sin instalarse en ninguno. Representa la capacidad de moverse libremente entre mundos, contextos y personas.",
    interpretation: "Un Camino de Vida 9 sugiere que tu energía está orientada hacia la adaptación y la unificación de lo que otros separan. Tu trabajo es el desapego: soltar lo que te ata a un lugar, una identidad o un resultado fijo.",
    example: "El 9 es el último dígito simple y el más versátil. Su fuerza no está en lo que es, sino en lo que puede volverse. Numerología GG33 dice que el 9 exitoso es quien fluye donde otros se estancan.",
    relationshipWithOther: "El 9 funciona con prácticamente cualquier número porque su energía se ajusta. Sin embargo, puede generar tensión con el 4 (estabilidad rígida) y el 8 (control material).",
    scientificNote: "Las propiedades matemáticas del 9 son reales, pero su interpretación como 'adaptabilidad' o 'desapego' es una construcción simbólica sin respaldo científico.",
    sourceIds: ["britannica-numerology", "gg33-academy"],
  },
  {
    number: 11,
    title: "El Vidente",
