export const ARCHETYPES: Record<number, any> = {
  ...
  9: { number: 9, name: "EL ADAPTADOR / EL MÍSTICO", keywords: ["Adaptación", "Compasión", "Sabiduría Universal", "Finalización"], essence: "El 9 es el número de la culminación y la sabiduría adquirida. Su mayor fortaleza es su capacidad de adaptación: absorbe la energía de su entorno y se moldea a sí mismo para tener éxito. Es el 'espejo' que ayuda a otros a verse a sí mismos. Su misión es completar ciclos y dejar un legado, pero debe protegerse de los apegos emocionales que pueden desviarlo.", description: "Tu energía es la del todo.", quote: "Una sola persona puede cambiar el mundo.", color: "#2E5C8A", colorLight: "#D0E0F0", careers: ["Filántropo", "Activista", "Terapeuta", "Coach", "ONG", "Artista social"] },
