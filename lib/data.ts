export const ARCHETYPES: Record<number, any> = {
  1: { number: 1, name: "EL LÍDER", keywords: ["Independiente", "Innovador", "Determinado"], description: "Naciste para liderar.", quote: "El poder no se te da. Lo tomás.", color: "#D4A843", colorLight: "#F5E6C8", careers: ["Emprendedor", "CEO", "Líder político", "Consultor", "Director", "Inversor"] },
  2: { number: 2, name: "EL MEDIADOR", keywords: ["Diplomático", "Sensible", "Cooperativo"], description: "Tu energía es la del puente.", quote: "La verdadera fuerza está en la unión.", color: "#E8B4B8", colorLight: "#F5E0E3", careers: ["Diplomático", "Terapeuta", "Mediador", "RRHH", "Asistente social", "Psicólogo"] },
  3: { number: 3, name: "EL COMUNICADOR", keywords: ["Creativo", "Expresivo", "Optimista"], description: "Tu energía es la de la expresión.", quote: "El mundo es tu lienzo.", color: "#FF8C42", colorLight: "#FFE4D1", careers: ["Artista", "Escritor", "Actor", "Diseñador", "Periodista", "Cantante"] },
  ...
  5: { number: 5, name: "EL AVENTURERO", keywords: ["Versátil", "Libre", "Curioso"], description: "Tu energía es la del viento.", quote: "La vida es demasiado corta para seguir el camino trillado.", color: "#C44536", colorLight: "#F5D5D0", careers: ["Viajero", "Periodista", "Emprendedor digital", "Fotógrafo", "Marketing", "Relaciones públicas"] },
  6: { number: 6, name: "EL NUTRIDOR", keywords: ["Responsable", "Protector", "Armonioso"], description: "Tu energía es la del hogar.", quote: "El amor más grande es el que te das para poder dar.", color: "#8FBC8F", colorLight: "#E0F0E0", careers: ["Médico", "Enfermero", "Docente", "Terapeuta familiar", "Chef", "Diseñador de interiores"] },
  ...
  9: { number: 9, name: "EL ADAPTABLE", keywords: ["Adaptabilidad", "Desapego", "Flexibilidad"], essence: "El 9 es el swing path. No tiene origen fijo ni destino predeterminado. Su mayor fortaleza es su adaptabilidad extrema: maneja cualquier situación que le toque sin resistencia. Su trabajo es unificar lo que otros separan. No es servicio desinteresado ni compasión — es desapego funcional.", description: "Tu energía es la del movimiento.", quote: "Fluyo donde otros se estancan.", color: "#2E5C8A", colorLight: "#D0E0F0", careers: ["Consultor", "Mediador internacional", "Diplomático", "Estratega", "Comercio exterior", "Relaciones públicas"] },
  11: { number: 11, name: "EL VISIONARIO", keywords: ["Intuitivo", "Inspirador", "Iluminado"], description: "Tu energía es la del puente entre mundos.", quote: "Los ojos ven lo que la mente está preparada para comprender.", color: "#8B5CF6", colorLight: "#E5D5FF", careers: ["Mentor", "Sanador", "Artista espiritual", "Consultor", "Escritor inspiracional", "Innovador"] },
  22: { number: 22, name: "EL CONSTRUCTOR MAESTRO", keywords: ["Práctico", "Visionario", "Manifestador"], description: "Tu energía es la del arquitecto divino.", quote: "Soñá en grande, construí con determinación.", color: "#4682B4", colorLight: "#D0E0F0", careers: ["Arquitecto", "Ingeniero civil", "CEO de gran escala", "Urbanista", "Desarrollador", "Líder global"] },
  33: { number: 33, name: "EL MAESTRO", keywords: ["Compasivo", "Sabio", "Transformador"], description: "Tu energía es la del amor universal en acción.", quote: "El amor no es lo que decís. Es lo que hacés.", color: "#B8860B", colorLight: "#F5E6C8", careers: ["Maestro", "Sanador", "Guía espiritual", "Coach humanista", "Artista curativo", "Filántropo"] }
};
...
export const ENERGY_TYPES: Record<number, any> = {
  ...
  9: { name: "Adaptación", color: "#2E5C8A", icon: "🌊", insights: ["Fluí con lo que venga.", "Tu capacidad de adaptarte es tu mayor fortaleza."] },
...
export const YEAR_TYPES: Record<number, any> = {
  ...
  9: { name: "Año de Adaptación", description: "Flexibilidad, desapego, unificar caminos." },
